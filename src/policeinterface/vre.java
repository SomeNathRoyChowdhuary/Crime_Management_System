 ...
 * @author Some Nath
 */
public class vre extends javax.swing.JFrame implements police{

    /**
     * Creates new form vre
     */
    public vre() {
        initComponents();
        uptabel();
    ...
    public void uptabel(){
       try {
            ...
            ResultSet rs = st.executeQuery("select * from verify ");
    ...
    public void vmain() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
